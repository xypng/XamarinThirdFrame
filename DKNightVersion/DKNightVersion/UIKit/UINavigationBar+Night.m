...
- (DKAttributePicker)dk_titleTextAttributes {
    return objc_getAssociatedObject(self, @selector(dk_titleTextAttributes));
}

- (void)dk_setTitleTextAttributes:(DKAttributePicker)picker {
    objc_setAssociatedObject(self, @selector(dk_titleTextAttributes), picker, OBJC_ASSOCIATION_COPY_NONATOMIC);
    self.titleTextAttributes = picker(self.dk_manager.themeVersion);
